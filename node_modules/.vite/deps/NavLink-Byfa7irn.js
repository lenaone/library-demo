...
import { Button_default, useButtonProps } from "./Button-Drq05KJo.js";
import { SelectableContext_default, dataAttr, makeEventKey, useEventCallback } from "./useIsomorphicEffect-BvcUs80O.js";
...
var NavItem = /* @__PURE__ */ import_react.forwardRef((_ref, ref) => {
	let { as: Component = Button_default, active, eventKey } = _ref, options = _objectWithoutPropertiesLoose$1(_ref, _excluded$1);
...
var NavLink = /* @__PURE__ */ import_react.forwardRef(({ bsPrefix, className, as: Component = Anchor_default, active, eventKey, disabled = false,...props }, ref) => {
...
//#endregion
export { Anchor_default, NavContext_default, NavItem_default, NavLink_default, TabContext_default, useCallbackRef, useEventListener, useForceUpdate };
//# sourceMappingURL=NavLink-Byfa7irn.js.map